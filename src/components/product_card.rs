...
pub fn ProductCard(
    ...
    rsx! {
        ...
        Link {
            ...
            div {
                // FIXED: Use aspect-square consistently and remove conflicting size constraints
                class: "{top_class} boop rounded-lg relative overflow-hidden p-4 bg-ui-bg-subtle shadow-elevation-card-rest rounded-large group-hover:shadow-elevation-card-hover transition-shadow ease-in-out duration-150 aspect-square w-full border-gray-200 border",
                ...
                if let Some(img_url) = thumbnail_url {
                    ...
                    // FIXED: Constrain SMILES viewer to the card bounds
                    div {
...
pub fn WideProductCard(
    ...
    rsx! {
        Link {
            ...
            if alert {
                div {
                    class: "{top_class} animated-blue-border bg-white relative boop rounded-lg overflow-hidden p-4 bg-white shadow-elevation-card-rest group-hover:shadow-elevation-card-hover transition-shadow ease-in-out duration-150 flex flex-col md:flex-row md:h-64",
                    ...
                    div {
                        ...
                        h3 {
                            class: "font-normal font-sans txt-large text-ui-fg-base mb-1 line-clamp-2",
                            "{display_title}"
                        }
                ...
                div {
                    class: "{top_class} relative boop rounded-lg overflow-hidden p-4 bg-white shadow-elevation-card-rest group-hover:shadow-elevation-card-hover transition-shadow ease-in-out duration-150 border-gray-200 border flex flex-col md:flex-row md:h-64",
