        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(ColumnDef::new(AffiliateUsers::Email).string().not_null())
                    .col(ColumnDef::new(AffiliateUsers::Country).string().not_null())
                    .col(
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(ColumnDef::new(Discounts::AffiliateId).string())
                    .col(
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(ColumnDef::new(AffiliateWithdrawls::TxId).string())
                    .col(
